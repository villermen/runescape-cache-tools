    ...
    public class TestCacheConstructor
    {
        ...
        public void ConstructTestCache()
        {
            var files = new List<Tuple<Index, int>>
            {
                ...
                new Tuple<Index, int>(Index.Music, 30),
            ...
            using (var downloader = new CacheDownloader())
            {
                ...
                {
                    var file = downloader.GetFile<DataCacheFile>(fileTuple.Item1, fileTuple.Item2);
                    cache.PutFile(file);
                }
                ...
                foreach (var fileTuple in files)
                {
                    cache.GetFile<DataCacheFile>(fileTuple.Item1, fileTuple.Item2);
                }
            }
        }
    }
